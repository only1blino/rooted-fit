...
export default function HomeScreen() {
  ...
  const locationLabel = locationSuggestionLabel(profile.country, profile.city);
  const resolvedLocation = resolveFoodLocation(profile.country, profile.city);
  const seasonCue = seasonalFoodCues(profile.country, profile.city);
  const foodSuggestions = suggestedFoods(profile.country, profile.city).filter((item) => item.toLowerCase().includes(foodQuery.toLowerCase()));
  const mealSuggestions = suggestedMeals(profile.country, profile.city);

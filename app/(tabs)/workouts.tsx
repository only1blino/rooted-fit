...
import { applyTodayUnavailableResources, buildWeeklyPlan, loadExerciseLogs, loadProfile, loadTodayUnavailableResources, loadWorkoutSessionStates, saveExerciseLogs, saveProfile, saveTodayUnavailableResources, saveWorkoutSessionStates, type LocalExerciseLog, type UserProfile, type WorkoutDifficulty, type WorkoutSessionState } from "@/lib/rootedfit-profile";
...
export default function WorkoutsScreen() {
  ...
  const effectiveProfile = useMemo(() => profile ? applyTodayUnavailableResources(profile, todayUnavailableResources) : null, [profile, todayUnavailableResources]);
  ...
  const toggleTodayAvailability = async (resource: string) => {
    ...
    await saveTodayUnavailableResources(next);
  };
